...
def main():
    ...
    if not probe.get("funding") or probe["genesis"] != network["executionGenesis"]:
    ...
    command = [
        ...
        "--suggested-fee-recipient=" + probe["address"],
    ]
    ...
    record = {
        "pid": process.pid, "chainId": 3151915, "command": command,
        "withdrawalRecipient": probe["address"], "suggestedFeeRecipient": probe["address"],
    ...
    print(json.dumps({"pid": process.pid, "chainId": 3151915, "validatorCount": 1}))
