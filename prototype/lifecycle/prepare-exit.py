...
from observe import context, read_json, validator_at
...
def main():
    ...
    result = {
        ...
        "fundingBlock": probe["funding"]["blockNumber"],
        "availabilityScope": "Obtained after this controlled fixture was funded and registered; this does not solve pre-funding canonical admission.",
    }
