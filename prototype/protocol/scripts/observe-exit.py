#!/usr/bin/env python3
"""Read bounded exit observations from the explicitly identified local prototype."""
...
def main():
    ...
    expected_index = args.expected_index or ("63" if network["chainId"] == 3151914 else None)
    ...
    if network["chainId"] == 3151915 and expected_key_hash is None:
