module github.com/DigitalGuards/QuantaPool/prototype/protocol

go 1.26.5

require (
	github.com/theQRL/go-qrl v0.0.0-20260326201015-e36df34a2434
	github.com/theQRL/qrysm v0.0.0
)
...
require (
	...
	github.com/theQRL/go-bitfield v0.0.0-20231204084259-f3b877be8f63 // indirect
	github.com/theQRL/go-qrllib v0.9.0 // indirect
...
replace github.com/theQRL/qrysm => github.com/cyyber/qrysm v0.2.1-0.20260914123539-9b57ae0bbfba

// Match the exact dependency overrides of the pinned, unmodified Qrysm module.
