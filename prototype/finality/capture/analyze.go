...
func run() {
	...
	require(manifest.QrysmCommit == "9b57ae0bbfba13e5f4d9cb0b7c6a45dd02a36de3", "capture source revision mismatch")
	...
	require(len(manifest.Updates) > 0 && len(manifest.Updates) <= 4, "capture must contain one to four bounded updates")
