...
Rewritten for v2 ABIs. Running on `46.28.70.102` (docker-compose under `/opt/quantapool/monitoring`). Dashboards live at `https://grafana.46-28-70-102.nip.io`. As of v2.1 redeploy: `pooled=101 shares=100 rate=1.01 validators=0`. Discord webhook wired for critical/warning/info receivers.
